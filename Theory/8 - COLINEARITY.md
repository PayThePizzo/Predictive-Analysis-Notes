...
Multicollinearity arises when one (or more) predictor(s) can be expressed as a linear combination of the other
predictors.
...
In fact, under multicollinearity, the least squares solution does not exist (singularity).
